/**
 * Editable values for the Privacy Policy and Terms of Service pages. Confirm
 * these before relying on the documents:
 *  - CONTACT_EMAIL must be an inbox someone actually monitors (Google's OAuth
 *    review and users will use it).
